    ...
    async def generate_song(
        ...
        try:
            ...
            if audio_files:
                ...
                audio_url = f"{http_api_url}/view?filename={filename}&type=output{subfolder_param}"
                    ...
                    await __event_emitter__(
                        {
                            "type": "status",
                            "data": {
                                "description": "🎉 Song generated! URL is ready.",
                                "done": True,
                            },
                        }
                    )
                return f"The song was generated successfully. Please present this URL to the user as is including subfolder in markdown format: {audio_url}"
            else:
